...
class PersonaSearch extends Persona
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['nombre', 'apellido_pa', 'apellido_ma', 'foto', 'curp', 'telefono', 'email'], 'safe'],
        ];
    }
    ...
    public function search($params, $formName = null)
    {
        ...
        $query->andFilterWhere(['ilike', 'nombre', $this->nombre])
            ->andFilterWhere(['ilike', 'apellido_pa', $this->apellido_pa])
            ->andFilterWhere(['ilike', 'apellido_ma', $this->apellido_ma])
